...
### 3. Calculate the probabilities of choosing the i'th configuration to be a parent (of another descendent configuration) $$P(i) = \frac{fitness(i)}{\sum_{k \, \text{(all solutions k)}} fitness(k)}$$
